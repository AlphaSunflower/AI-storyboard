...
export function NotFoundBrickBreaker({
  ...
  className,
  cta = "返回首页",
  description = "页面不存在。打碎 404 砖墙，或返回首页。",
  href = "/",
  title = "找不到网页",
  ...sectionProps
      ...
      <div className="mx-auto grid w-full max-w-3xl gap-5">
        ...
        <Card className="w-full">
          ...
          <CardFooter className="grid grid-cols-2 gap-3 px-4 pb-5 sm:flex sm:justify-center sm:gap-4">
            ...
            <Button className="min-h-11 w-full motion-reduce:transition-none sm:w-auto" variant="secondary" render={<Link to={href} />} nativeButton={false}>{cta}</Button>
          </CardFooter>
        </Card>
